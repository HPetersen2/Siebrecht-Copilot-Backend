...
import django_rq
from auth_app.utils import send_reset_password_email
from .serializers import CustomTokenObtainPairSerializer, PasswordResetSerializer, SetNewPasswordSerializer
    ...
    def post(self, request):
        ...
        try:
            ...
            if user.is_active:
                ...
                verification_link = f'http://localhost:4200/auth/confirm_password.html?uid={uid}&token={token}'
